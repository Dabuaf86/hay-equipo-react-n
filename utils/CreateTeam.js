...
// const lista_5 = data.lists.filter(lista => {
// return lista.name === "lista_5" ? lista.players : null
// });
...
const createValueTeam = playersList => {
	...
	return {
		listAverage,
		goalkeepers: goalkeepers.map(gk => gk.alias),
		team1Average,
		team2Average,
		team1: team1.map(player => player.alias),
		team2: team2.map(player => player.alias),
	};
};
